...
drop_cols = ['Unnamed: 0', 'season_year', 'season_type', 'week', 'team', 'full_name', 'position', 'receiving_rec', 'receiving_tar', 'yds_per_rush', 'passing_yds', 'passing_tds', 'rushing_yds', 'rushing_tds', 'total_points', 'cmp_']
