...
#     contest_file = 'Data/contest-standings-sunday-monday-night-week4.csv'
#     point_file = 'Data/Week4_player_scores.txt'
#     delimiter = ';'

#
#     week_4 = dfAnalysis()
#     self.contest_df = week_4.load_self.contest_df(contest_file, point_file)
#     self.point_df = week_4.load_self.point_df(point_file, delimiter=delimiter)
#     self.lineup_df, self.percent_df = week_4.arrange_contest_data(self.contest_df)
#     self.percent_df = week_4.clean_self.percent_df(self.percent_df, defense_dict)
#     self.point_df = week_4.clean_self.point_df(self.point_df)
#     point_percent = week_4.merge_data(self.percent_df, self.point_df)
